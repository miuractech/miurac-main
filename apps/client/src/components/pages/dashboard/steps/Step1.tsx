        ...
        <div>
            <div className="w-full rounded-[15px] flex flex-col bg-[#802EEA] p-3 justify-center text-center items-center">
                ...
                <button 
                    ...
                    className="bg-white text-[14px] text-black px-3 py-2 rounded-[10px] my-2">
                        Start New Project
                </button>
            </div>
            <div className="my-3 mx-2">
                ...
                <button 
                    onClick={props.nextStep}
                    className="w-[180px] h-[180px] my-3 flex flex-col justify-center items-center border-[#782DED] rounded-[20px] border-2 border-dashed">
