...
import { ActionIcon, AppShell, Burger, Button, Header, Modal } from '@mantine/core';
    ...
    >
      <Link to="/">
        <div className="flex items-center cursor-pointer h-full">
          <Logo height={mediaMatch?40:30} imgProps={{ className: 'md:mr-2 mr-0 h-4 md:h-10' }} />
          <span
            id="ch1"
          ...
          <span id="ch2" className="lato font-black text-xl md:text-3xl text-[#3C4043]">
            I
          </span>
          <span id="ch3" className="lato font-black text-xl md:text-3xl text-[#3C4043]">
            U
          </span>
          <span id="ch4" className="lato font-black text-xl md:text-3xl text-[#3C4043]">
            R
          </span>
          <span id="ch5" className="lato font-black text-xl md:text-3xl text-[#3C4043]">
            A
          </span>
          <span id="ch6" className="lato font-black text-xl md:text-3xl text-[#3C4043]">
            C
          </span>
        </div>
      </Link>
      <div className="flex items-center gap-5">
        <CTA style={{ height: mediaMatch?40:30, padding:mediaMatch?"12px 20px":"8px 12px", }} id={'topbar'} />
        <ActionIcon
        variant='transparent'
        size={'xl'}
